...
class UserServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(userService, "MIN_YEARS_REQUIRED", 18);
    }
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByFirstName() {
        ...
        userService.findByFirstName(USER_FIRST_NAME);
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByLastName() {
        ...
        userService.findByLastName(USER_LAST_NAME);
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByAddress() {
        ...
        userService.findByAddress(USER_ADDRESS);
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByPhoneNumber() {
        ...
        userService.findByPhoneNumber(USER_PHONE_NUMBER);
        ArgumentCaptor<String> argumentCaptor = ArgumentCaptor.forClass(String.class);
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByBirthDate() {
        ...
        userService.findByBirthDate(USER_BIRTHDAY);
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void findByBirthDateRangeBadRequest() {
        assertThrows(UserBirthDateRangeBadRequestException.class, () -> userService.findByBirthDateRange(USER_BIRTHDAY.plusDays(1), USER_BIRTHDAY));
...
//        assertEquals(response.getStatusCode(), HttpStatus.OK);
    ...
    void patchUser() {
        ...
        userService.patchUser(user, user.getId());
...
//        assertEquals(response.getStatusCode(), HttpStatus.CREATED);
    ...
    void createUserWithException() {
        assertThrows(UserRequiredAgeException.class, () -> userService.createUser(new User(1L, LocalDate.now())));
//        assertEquals(response.getStatusCode(), HttpStatus.BAD_REQUEST);
    }
}